...
public class VideoPanelMainPanel : MonoBehaviour
{
    public Button _mainBtn, _hybBtn, _hyb2Btn, _marketBtn;

    public List<Sprite> _mainSprite, _hybSprite, _hyb2Sprite, _marketSprite;
    ...
    void Start()
    {
        ...
        _marketBtn.onClick.AddListener(MarketBtnClick);
        MainBtnClick();
    }
    ...
    void MarketBtnClick()
    {
        _imageChangePanel.SetNewList(_marketSprite);
        onEffect(3);
    }
