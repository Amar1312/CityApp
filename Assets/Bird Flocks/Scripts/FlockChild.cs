...
public class FlockChild :MonoBehaviour
{
	...
	public Animation _modelAnimation;       // Reference to legacy animation
	public Animator _animator;              // Reference to generic animation
	...
	public Vector3 _landingPosOffset;		// Offsets the birds position from the landing spot when landing/landed
	...
	[HideInInspector]
	public LandingSpot _landingSpot;            // Reference to the current landing spot
	...
	[HideInInspector]
	public float _speed, _damping, _targetSpeed, _avoidValue, _avoidDistance;
	// _speed current speed of bird 
	// _damping used for steering (steer speed)
	// _targetSpeed max bird speed
	// _avoidValue random value used to check for obstacles. Randomized to lessen uniformed behaviour when avoiding
	// _avoidDistance how far from an obstacle this can be before starting to avoid it

	[HideInInspector]
	public bool _dived = true, _soar = true, _landing, _landed, _move = true, _avoid = true, _closeToSpot;
	// _dived indicates if this bird has recently performed a dive movement
	// _soar indicates if this is soaring
	// _landing indicates if bird is landing or sitting idle
	// _landed indicates if bird is landing or sitting idle
	// _move indicates if bird can fly
	// _avoid is avoiding
	// _closeToSpot indicates if the bird is close to a landing spot
